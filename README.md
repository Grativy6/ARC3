...
- Do not operate ARC3 against live services, accounts, credentials, personal data, production systems, physical systems, or consequential decisions.
- Do not use it for weapons, surveillance, coercion, security exploitation, hazardous work, or high-impact decisions about people.
- Do not infer safety, authority, general intelligence, ethical approval, or deployment readiness from a replay, receipt, score, or successful run.
- For any independent historical reproduction, use the isolation and mandatory-stop conditions in [SAFETY.md](SAFETY.md). Such work is not an official continuation of ARC3.

Read the controlling retirement materials:

- [STATUS.md](STATUS.md) — project state and preserved boundary
- [SAFETY.md](SAFETY.md) — risks, unsupported uses, and stop conditions
- [RESPONSIBLE_USE.md](RESPONSIBLE_USE.md) — the author's public use position
- [AGENTS.md](AGENTS.md) — non-execution instructions for automated systems
- [LICENSE](LICENSE) — prospective retirement notice and historical MIT-0 boundary
...
Continuing development moved to [Strongwiz](https://github.com/Grativy6/strongwiz), a separate project with its own code, license, safeguards, evidence, and release decisions. That relationship is not a safety certification, and no ARC3 authority or result transfers merely because the successor is named here.

Christopher D. Pang is ARC3's author and steward. AI systems assisted as development tools; they are not co-authors, owners, or authorities.
