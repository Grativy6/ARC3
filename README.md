...
## Wise Scientist clean-room playground

This branch is an isolated sibling experiment rooted at the Build 002 merge
`bea1eac99cb0f1b351526b1dc487d132ba1d40ef`. It must not inherit implementation,
receipts, traces, replays, or game-specific discoveries from Build 003.
...
- do not inspect or import another ARC3 checkout, Build 003 branch, PR, trace, replay, or artifact;
...
- stop and report the boundary if a required build step cannot be completed without writing or
  retrieving project state outside this playground.
...
authority for a reader. See [`playground/README.md`](playground/README.md) for the full boundary.
