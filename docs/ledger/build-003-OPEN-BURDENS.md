...
- **Status:** OPEN; OFFICIAL RECHECK DID NOT REACH LEVEL-3 BOUNDARY
- **Stage:** 10
- **Opened:** 2026-08-25
- **Owner:** Codex
...
- **Next discriminating action:** Run Campaign 17 with the locally verified B-003-0009 repair. Require progress beyond the Campaign 15 failure states while preserving every still-unresolved observable compound group after accepted actions.
...
- **Next discriminating action:** Freeze D-003-0008 and run official Campaign 17. Require it to preserve the earlier route, restore the certified sparse-target separation, and pass the Campaign 16 failure boundary.
