...
journal.append(episode_id='episode-death', game_id='redacted', level_index=0, step_index=1, event_type='action.selected', source=source, scope='episode', payload={{'selected_action': {{'name': chosen.value, 'coordinate': None}}, 'candidate_utilities': [], 'selected_probe_or_plan_id': 'PLAN-1', 'active_hypothesis_ids': ['H-1'], 'predicted_outcome_ids': ['P-1'], 'rationale_category': 'follow_plan'}}, code_identity=code, event_id='E-SELECTED')
journal.append(episode_id='episode-death', game_id='redacted', level_index=0, step_index=1, event_type='action.submitted', source=source, scope='episode', payload={{'selected_event_id': 'E-SELECTED'}}, code_identity=code, event_id='E-SUBMITTED')
