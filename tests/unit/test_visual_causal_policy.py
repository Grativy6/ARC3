...
def test_hierarchy_preterminal_retry_reservation_clears_on_nonterminal_mismatch() -> None:
    ...
    unchanged_mismatch = replace(retry_observation, returned_action=retry_action)
